...
Game.create!([
...

  {
    ...
    cover: 'https://static-cdn.jtvnw.net/ttv-boxart/Hello%20Neighbor.jpg'
  }

  {
    ...
    cover: 'https://static-ie.gamestop.ie/images/products/257449/3max.jpg'
  }

  {
    ...
    cover: 'https://images-na.ssl-images-amazon.com/images/I/8184Jv-yA-L._SL1500_.jpg'
  }

  {
    ...
    cover: 'https://images-na.ssl-images-amazon.com/images/I/81RbwMABstL._SL1455_.jpg'
  }

  {
    ...
    cover: 'https://gpstatic.com/acache/34/03/1/uk/packshot-0640d36c1087a85f2079366e6049f9d3.jpg'
  }

  {
    ...
    platform: 'Nintendo 3DS',
    cover: 'http://i.imgur.com/UCkJFu4.jpg'
  }
])
